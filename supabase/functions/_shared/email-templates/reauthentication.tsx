...
export const ReauthenticationEmail = ({ token }: ReauthenticationEmailProps) => (
  <Html lang="nl" dir="ltr">
    <Head />
    <Preview>Je verificatiecode voor BengCert</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footer}>
          Deze code verloopt na korte tijd. Heb je dit niet aangevraagd? Dan kun je deze e-mail negeren.
        </Text>
      </Container>
    </Body>
  </Html>
...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '22px', fontWeight: 'bold' as const, color: '#28235D', margin: '0 0 30px' }
